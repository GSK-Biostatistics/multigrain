...
In the example above names were automatically generated (`"H1"`, `"H2"`, `"H3"`, and `"H4"`). This is controlled by the `names` _optional_ argument, which, if unspecified, will name the hypotheses `"H1"`, `"H2"`, and so on.
